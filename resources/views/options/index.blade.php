            ...
            <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
              ...
              <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                <div class="mr-0 mr-md-auto">
                  <h2 class="mb-0 text-heading fs-22 lh-15">Lease Options
                      <span
                    class="badge badge-white badge-pill text-primary fs-18 font-weight-bold ml-2">{{ $option_count }}</span>
                  </h2>
                  {{-- <p>Lorem ipsum dolor sit amet, consec tetur cing elit. Suspe ndisse suscipit</p> --}}
                </div>
                <div>
                  <a href="{{ route('options.create') }}" class="btn btn-success btn-lg">
                    <span>Add New Lease Option</span>
                ...
                <table class="table table-hover border rounded-lg mb-6 bg-white">
                  ...
                  <tbody>
                      ...
                      <tr class="shadow-hover-xs-2 bg-hover-white">
                        ...
                        <a href="#"
                            class="text-dark font-weight-500 hover-primary pt-1">{{ $option->name }}</a>
                        </td>
