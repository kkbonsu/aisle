                        ...
                        <div class="card border-0">
                          ...
                          <div class="card-img-overlay d-flex flex-column bg-gradient-3 rounded-lg">
                            <div class="d-flex mb-auto">
                              ...
                              <a href="#" class="badge badge-indigo">For Sale</a>
                            </div>
                            <div class="px-2 pb-2">
          ...
          <div class="col-md-6 col-lg-2 mb-6 mb-md-0">
            ...
            <ul class="list-group list-group-flush list-group-no-border">
              <li class="list-group-item bg-transparent p-0">
                <a href="#" class="text-muted lh-26 font-weight-500 hover-white">Apartment For Sale</a>
              </li>
              <li class="list-group-item bg-transparent p-0">
              ...
              <li class="list-group-item bg-transparent p-0">
                <a href="#" class="text-muted lh-26 font-weight-500 hover-white">Offices For Sale</a>
              </li>
            </ul>
          </div>
          <div class="col-md-6 col-lg-2 mb-6 mb-md-0">
