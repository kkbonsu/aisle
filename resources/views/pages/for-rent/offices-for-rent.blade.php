...
<html lang="en">
  <head>
    ...
    <title>AISLE || Offices for rent</title>
    <!-- Google fonts -->
        ...
        <div class="container">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pt-6 pt-lg-2 lh-15 pb-5">
              ...
              <li class="breadcrumb-item active" aria-current="page">Offices for rent</li>
            </ol>
            <h1 class="fs-30 lh-1 mb-0 text-heading font-weight-600">Our Offices for rent for you</h1>
          </nav>
        </div>
      </section>
          ...
          <div class="row">
            ...
            <div class="col-lg-8 mb-8 mb-lg-0 order-1 order-lg-2">
              <div class="row align-items-sm-center mb-4">
                <div class="col-md-6">
                  <h2 class="fs-15 text-dark mb-0">We found <span class="text-primary">Offices</span> properties
                    available for
                    you
                  </h2>
                </div>
