                ...
                <table class="table table-hover border rounded-lg mb-6 bg-white">
                  <thead class="thead-sm thead-black">
                    <tr>
                      ...
                      <th scope="col" class="border-top-0 px-6 pt-5 pb-4">Full name</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">Email</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">Role</th>
                  ...
                  <tbody>
                      ...
                      <tr class="shadow-hover-xs-2 bg-hover-white">
                        ...
                        <a href="#"
                            class="text-dark font-weight-500 hover-primary pt-1">{{ $user->name }}</a>
                        </td>
