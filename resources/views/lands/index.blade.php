            ...
            <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
              ...
              <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                <div class="mr-0 mr-md-auto">
                  <h2 class="mb-0 text-heading fs-22 lh-15">Lands<span
                ...
                <div>
                  <a href="{{ route('lands.create') }}" class="btn btn-success btn-lg">
                ...
                <table class="table table-hover bg-white border rounded-lg">
                  <thead class="thead-sm thead-black">
                    <tr>
                      ...
                      <th scope="col" class="border-top-0 px-6 pt-5 pb-4">Land Title</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">Negotiable</th>
                          ...
                          <div class="media">
                            <div class="w-120px mr-4 position-relative">
                              <a href="#">
                                ...
                                @if ($loop->first)
                                  <img src="{{asset('/land_images/'.$image->name)}}" alt="{{ $land->name }}">
                                @endif
                                @endforeach
                              </a>
                            ...
                            <div class="media-body">
                              <a href="#" class="text-dark hover-primary">
                                <h5 class="fs-16 mb-0 lh-18">{{ $land->area }}</h5>
                              </a>
                              {{-- <p class="mb-1 font-weight-500">{{ $land->price }}</p> --}}
                              <span class="text-heading lh-15 font-weight-bold fs-17">&#8373;{{ $land->price }}</span>
                              <span class="text-gray-light"></span>
                            </div>
                          </div>
                        </td>
                        <td class="align-middle">{{ $land->negotiable }}</td>
                        <td class="align-middle">
                            <a class="btn btn-info" href="{{ route('lands.show', $land->id) }}">Show</a>
                            <a class="btn btn-primary" href="{{ route('lands.edit',$land->id) }}">Edit</a>
                            {!! Form::open(['method' => 'DELETE','route' => ['lands.destroy', $land->id],'style'=>'display:inline']) !!}
