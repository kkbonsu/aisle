            ...
            <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
              <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                <div class="mr-0 mr-md-auto">
                  <h2 class="mb-0 text-heading fs-22 lh-15">{{ $land->name }}'s Details
                      {{-- <span
              ...
              <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <img src="{{asset('/land_images/'.$image->name)}}" alt="Image of land" class="img-thumbnail" style="width: 4000px; height: 200px">
                  </div>
                  @endforeach
                </div>
            </div>
