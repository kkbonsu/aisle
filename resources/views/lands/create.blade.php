            ...
            <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
              ...
              <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                <div class="mr-0 mr-md-auto">
                  <h2 class="mb-0 text-heading fs-22 lh-15">Create Land
                      {{-- <span
                ...
                <div>
                  <a href="{{ route('lands.index') }}" class="btn btn-dark btn-lg">
                    <span>Back</span>
              ...
              {!! Form::open(array('route' => 'lands.store', 'method' => 'POST', 'files' => true, 'enctype' => 'multipart/form-data')) !!}
              <div class="row">
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6">
                      <div class="form-group">
                          ...
                          {!! Form::text('type', null, array('placeholder' => '', 'class' => 'form-control')) !!}
                      </div>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-6">
                      <div class="form-group">
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6">
                      <div class="form-group">
                          ...
                          {!! Form::select('negotiable', ['Yes' => 'Yes', 'No' => 'No'], array('class' => 'form-control')); !!}
                      </div>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-6">
                      <div class="form-group">
                          <strong>Land Photos:</strong>
